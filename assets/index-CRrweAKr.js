 ...
 */var Op;function HS(){if(Op)return Ei;Op=1;var n=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function s(r,c,m){var d=null;if(m!==void 0&&(d=""+m),c.key!==void 0&&(d=""+c.key),"key"in c){m={};for(var h in c)h!=="key"&&(m[h]=c[h])}else m=c;return c=m.ref,{$$typeof:n,type:r,key:d,ref:c!==void 0?c:null,props:m}}return Ei.Fragment=i,Ei.jsx=s,Ei.jsxs=s,Ei}var qp;function GS(){return qp||(qp=1,Fu.exports=HS()),Fu.exports}var x=GS(),Wu={exports:{}},ce={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var jp;function kS(){return jp||(jp=1,(function(n){function i(w,G){var $=w.length;w.push(G);e:for(;0<$;){var me=$-1>>>1,P=w[me];if(0<c(P,G))w[me]=G,w[$]=P,$=me;else break e}}function s(w){return w.length===0?null:w[0]}function r(w){if(w.length===0)return null;var G=w[0],$=w.pop();if($!==G){w[0]=$;e:for(var me=0,P=w.length,A=P>>>1;me<A;){var _=2*(me+1)-1,J=w[_],F=_+1,oe=w[F];if(0>c(J,$))F<P&&0>c(oe,J)?(w[me]=oe,w[F]=$,me=F):(w[me]=J,w[_]=$,me=_);else if(F<P&&0>c(oe,$))w[me]=oe,w[F]=$,me=F;else break e}}return G}function c(w,G){var $=w.sortIndex-G.sortIndex;return $!==0?$:w.id-G.id}if(n.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;n.unstable_now=function(){return m.now()}}else{var d=Date,h=d.now();n.unstable_now=function(){return d.now()-h}}var p=[],g=[],y=1,b=null,S=3,z=!1,q=!1,L=!1,U=!1,H=typeof setTimeout=="function"?setTimeout:null,X=typeof clearTimeout=="function"?clearTimeout:null,Q=typeof setImmediate<"u"?setImmediate:null;function Z(w){for(var G=s(g);G!==null;){if(G.callback===null)r(g);else if(G.startTime<=w)r(g),G.sortIndex=G.expirationTime,i(p,G);else break;G=s(g)}}function Y(w){if(L=!1,Z(w),!q)if(s(p)!==null)q=!0,ie||(ie=!0,Re());else{var G=s(g);G!==null&&Qe(Y,G.startTime-w)}}var ie=!1,W=-1,B=5,se=-1;function Ce(){return U?!0:!(n.unstable_now()-se<B)}function _e(){if(U=!1,ie){var w=n.unstable_now();se=w;var G=!0;try{e:{q=!1,L&&(L=!1,X(W),W=-1),z=!0;var $=S;try{t:{for(Z(w),b=s(p);b!==null&&!(b.expirationTime>w&&Ce());){var me=b.callback;if(typeof me=="function"){b.callback=null,S=b.priorityLevel;var P=me(b.expirationTime<=w);if(w=n.unstable_now(),typeof P=="function"){b.callback=P,Z(w),G=!0;break t}b===s(p)&&r(p),Z(w)}else r(p);b=s(p)}if(b!==null)G=!0;else{var A=s(g);A!==null&&Qe(Y,A.startTime-w),G=!1}}break e}finally{b=null,S=$,z=!1}G=void 0}}finally{G?Re():ie=!1}}}var Re;if(typeof Q=="function")Re=function(){Q(_e)};else if(typeof MessageChannel<"u"){var pt=new MessageChannel,ut=pt.port2;pt.port1.onmessage=_e,Re=function(){ut.postMessage(null)}}else Re=function(){H(_e,0)};function Qe(w,G){W=H(function(){w(n.unstable_now())},G)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(w){w.callback=null},n.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<w?Math.floor(1e3/w):5},n.unstable_getCurrentPriorityLevel=function(){return S},n.unstable_next=function(w){switch(S){case 1:case 2:case 3:var G=3;break;default:G=S}var $=S;S=G;try{return w()}finally{S=$}},n.unstable_requestPaint=function(){U=!0},n.unstable_runWithPriority=function(w,G){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var $=S;S=w;try{return G()}finally{S=$}},n.unstable_scheduleCallback=function(w,G,$){var me=n.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?me+$:me):$=me,w){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=$+P,w={id:y++,callback:G,priorityLevel:w,startTime:$,expirationTime:P,sortIndex:-1},$>me?(w.sortIndex=$,i(g,w),s(p)===null&&w===s(g)&&(L?(X(W),W=-1):L=!0,Qe(Y,$-me))):(w.sortIndex=P,i(p,w),q||z||(q=!0,ie||(ie=!0,Re()))),w},n.unstable_shouldYield=Ce,n.unstable_wrapCallback=function(w){var G=S;return function(){var $=S;S=G;try{return w.apply(this,arguments)}finally{S=$}}}})(ec)),ec}var Vp;function PS(){return Vp||(Vp=1,Iu.exports=kS()),Iu.exports}var tc={exports:{}},ct={};/**
 * @license React
...
Mas o meu clamor está subindo`},{title:"Espírito, Enche a Minha Vida",lyrics:`Espírito, enche a minha vida
